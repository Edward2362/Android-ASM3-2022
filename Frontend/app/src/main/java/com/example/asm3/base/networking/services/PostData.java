...
public class PostData extends AsyncTask<JSONObject, String, String> {
    ...
    public PostData(Context context, AsyncTaskCallBack callBack) {
    ...
    protected String doInBackground(JSONObject... data) {
        String message = apiService.postJSON(endPoint, data[0]);
        return message;
    }
