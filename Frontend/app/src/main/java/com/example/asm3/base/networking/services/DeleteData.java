...
public class DeleteData extends AsyncTask<JSONObject, String, String> {
    ...
    public DeleteData(Context context, AsyncTaskCallBack callBack) {
    ...
    protected String doInBackground(JSONObject... data) {
        String message = apiService.deleteJSON(endPoint);
        return message;
    }
