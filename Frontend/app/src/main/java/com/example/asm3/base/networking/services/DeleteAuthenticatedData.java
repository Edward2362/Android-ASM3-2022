...
public class DeleteAuthenticatedData extends AsyncTask<JSONObject, String, String> {
    ...
    public DeleteAuthenticatedData(Context context, AsyncTaskCallBack callBack) {
    ...
    protected String doInBackground(JSONObject... data) {
        String message = apiService.deleteJSON(endPoint, token);
        return message;
    }
