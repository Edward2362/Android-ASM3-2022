...
public class GetAuthenticatedData extends AsyncTask<JSONObject, String, String> {
    ...
    public GetAuthenticatedData(Context context, AsyncTaskCallBack callBack) {
    ...
    protected String doInBackground(JSONObject... data) {
        String message = apiService.getJSON(endPoint, token);
        return message;
    }
